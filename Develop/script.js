...
function timeToday() {
    setInterval(function() {
        var today = moment().format('LL') + " "+moment().format('LTS') ; // curret date and current time
...
for (var i=9; i<17; i++){
    ...
    /** Generating time, activity(timebblock) and saving buttons**/
for (i=9; i<17; i++){
    var timeId = "time"+i; // 1 timeblock label id
